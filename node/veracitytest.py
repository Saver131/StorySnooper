...
def scrapeFacebookPageFeedStatus(group_id,post_id,access_token):
	...
	if posterVeracity < 25:
		posterReason = "Forth Level Poster"
	elif posterVeracity <50:
		posterReason = "Third Level Poster"
	elif posterVeracity <75:
		posterReason = "Second Level Poster"
	else:
		posterReason = "First Level Poster"
